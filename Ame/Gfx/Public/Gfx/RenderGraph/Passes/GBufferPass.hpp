...
namespace Ame::Gfx
{
    class GBufferPass : public RG::Pass
    {
    public:
        ...
        static inline const std::array c_RenderTargetIds{
            RG::ResourceId(c_Normal_Metallic),          // RGBA8_UNORM
            RG::ResourceId(c_BaseColor_Roughness),      // RGBA8_UNORM
            RG::ResourceId(c_Emissive_AmbientOcclusion) // RGBA8_UNORM
        };
        ...
        static inline const RG::ResourceId c_DepthTargetId{
            c_Depth // D32_SFLOAT
        };
