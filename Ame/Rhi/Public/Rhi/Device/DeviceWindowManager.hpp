...
namespace Ame::Rhi
{
    ...
    public:
        ...
        /// </summary>
        [[nodiscard]] Co::result<uint8_t> GetBackbufferCount() const;

        /// <summary>
        /// Get the current backbuffer index.
        /// </summary>
        [[nodiscard]] Co::result<uint8_t> GetBackbufferIndex() const;

        /// <summary>
        /// Get the backbuffer at the specified index.
        /// </summary>
        [[nodiscard]] Co::result<CRef<Backbuffer>> GetBackbuffer(
            uint8_t index) const;

        /// <summary>
        /// Get the current backbuffer.
        /// </summary>
        [[nodiscard]] Co::result<CRef<Backbuffer>> GetBackbuffer() const;
