...
namespace Ame::Rhi
{
    ...
    PipelineState DeviceResourceAllocator::CreatePipelineState(
        const GraphicsPipelineDesc& desc)
    {
        ...
        ThrowIfFailed(
            nriCore.CreateGraphicsPipeline(nriDevice, graphicsDesc, nriPipeline),
            "Failed to create graphics pipeline");

        return PipelineState(*this, desc.Layout, nriPipeline);
    }
        ...
        const ComputePipelineDesc& desc)
    {
        ...
        nri::Pipeline* nriPipeline = nullptr;
        ThrowIfFailed(
            nriCore.CreateComputePipeline(nriDevice, computeDesc, nriPipeline),
