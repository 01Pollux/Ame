...
#include <Rhi/Device/Frame/DeferredResource.hpp>
...
namespace Ame::Rhi
{
    ...
    public:
        ...
        /// <summary>
        /// Defer the release of a descriptor pool.
        /// </summary>
        void DeferRelease(
        ...
        /// <summary>
        /// Defer the release of a pipeline layout.
        /// </summary>
        void DeferRelease(
    ...
    private:
        ...
        DeferredDescriptorPoolList m_DeferredDescriptorPools;
        DeferredDescriptorList     m_DeferredDescriptors;
        DeferredPipelineLayoutList m_DeferredPipelineLayouts;
        DeferredPipelineList       m_DeferredPipelineStates;
    };
} // namespace Ame::Rhi