...
#include <Rhi/Device/Frame/Frame.hpp>
...
namespace Ame::Rhi
{
        ...
        IDeviceMemoryAllocator& memoryAllocator)
    {
        ...
        m_DeferredDescriptorPools.Release(nriCore);
        m_DeferredDescriptors.Release(nriCore);
        m_DeferredPipelineLayouts.Release(nriCore);
        m_DeferredPipelineStates.Release(nriCore);
    }
    ...
    void Frame::DeferRelease(
        nri::DescriptorPool& nriDescriptorPool)
    {
        m_DeferredDescriptorPools.DeferRelease(nriDescriptorPool);
    }
    ...
    void Frame::DeferRelease(
        nri::PipelineLayout& nriPipelineLayout)
    {
        m_DeferredPipelineLayouts.DeferRelease(nriPipelineLayout);
    }
    
    void Frame::DeferRelease(
        nri::Pipeline& nriPipeline)
    {
        m_DeferredPipelineStates.DeferRelease(nriPipeline);
    }
