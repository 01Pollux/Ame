...
namespace Ame::Rhi
{
    ...
    using DeferredDescriptorPoolList = DeferredResourceList<
        nri::DescriptorPool,
        decltype([](nri::CoreInterface& nriCore, nri::DescriptorPool& nriDescriptorPool)
                 { nriCore.DestroyDescriptorPool(nriDescriptorPool); })>;
    ...
    using DeferredPipelineLayoutList = DeferredResourceList<
        nri::PipelineLayout,
        decltype([](nri::CoreInterface& nriCore, nri::PipelineLayout& nriPipelineLayout)
                 { nriCore.DestroyPipelineLayout(nriPipelineLayout); })>;
