...
namespace Ame::Rhi::VK
{
        ...
        const BufferDesc& bufferDesc)
    {
        ...
        SaveAllocation(buffer, { allocation, memory, shouldMap });
        ...
        nri::Buffer& buffer)
    {
        ...
        auto [allocation, memory, shouldMap] = ReleaseAllocation(vkBuffer);
        ...
        nri::Texture& texture)
    {
        ...
        auto [allocation, memory, _] = ReleaseAllocation(vkTexture);
        ...
        const VmaAllocationInfo& allocationInfo) const
    {
        nri::MemoryVKDesc memoryDesc{
            ...
            .vkMappedMemory  = allocationInfo.pMappedData,
