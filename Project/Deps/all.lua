...
add_requires("vulkan-headers",              {system = false, debug = _debug_packages})
add_requires("vulkan-memory-allocator",     {system = false, debug = _debug_packages})
if is_plat("windows") then
    add_requires("d3d12-memory-allocator",  {system = false, debug = _debug_packages})
end